...
(defrule refinement::initialize
    ...
    (bind ?vr (length$ (find-all-instances ((?o Offer))
        (and (neq ?o:Destination [nil]) (eq ?o:grade VERY_RECOMMENDED)))))
    (bind ?r  (length$ (find-all-instances ((?o Offer))
        (and (neq ?o:Destination [nil]) (eq ?o:grade RECOMMENDED)))))
    (bind ?p  (length$ (find-all-instances ((?o Offer))
        (and (neq ?o:Destination [nil]) (eq ?o:grade PARTIAL)))))
    (bind ?ns (length$ (find-all-instances ((?o Offer))
        (and (neq ?o:Destination [nil]) (eq ?o:grade NOT_SUITABLE)))))
